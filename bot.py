...
deck = [f'{color} {value}' for color in colors for value in values if value != 'Wild' and value != 'Wild Draw Four']
deck += ['Wild', 'Wild Draw Four'] * 4  # Add 4 Wild and 4 Wild Draw Four cards

# UNO game state (for simplicity)
game_state = {}
